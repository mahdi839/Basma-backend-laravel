...
class ProductsSlotController extends Controller
{
    ...
    {
        $home_category_products = Category::with(['products.images:id,product_id,image', 'products.variants','banner.banner_images'])->where('home_category', 1)->orderBy('priority')->get();
